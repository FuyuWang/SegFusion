...
class Workload:
    def __init__(self, workload_dir, workload_name, batch_size, layer2budgets):
        ...
        for layer_id, layer_name in enumerate(self.layers):
            ...
            P_budgets, Q_budgets, C_budgets, K_budgets, H_budgets, N_budgets = layer2budgets[operator['problem']['P']]
        ...
        if workload_name == 'mobilenetv2':
            self.graph.nodes[6].active_nodes = [5]
            self.graph.nodes[7].active_nodes = [5]
            self.graph.nodes[8].active_nodes = [5]

            self.graph.nodes[12].active_nodes = [11]
            self.graph.nodes[13].active_nodes = [11]
            self.graph.nodes[14].active_nodes = [11]
            self.graph.nodes[15].active_nodes = [14]
            self.graph.nodes[16].active_nodes = [14]
            self.graph.nodes[17].active_nodes = [14]

            self.graph.nodes[21].active_nodes = [20]
            self.graph.nodes[22].active_nodes = [20]
            self.graph.nodes[23].active_nodes = [20]
            self.graph.nodes[24].active_nodes = [23]
            self.graph.nodes[25].active_nodes = [23]
            self.graph.nodes[26].active_nodes = [23]
            self.graph.nodes[27].active_nodes = [26]
            self.graph.nodes[28].active_nodes = [26]
            self.graph.nodes[29].active_nodes = [26]

            self.graph.nodes[33].active_nodes = [32]
            self.graph.nodes[34].active_nodes = [32]
            self.graph.nodes[35].active_nodes = [32]
            self.graph.nodes[36].active_nodes = [35]
            self.graph.nodes[37].active_nodes = [35]
            self.graph.nodes[38].active_nodes = [35]

            self.graph.nodes[42].active_nodes = [41]
            self.graph.nodes[43].active_nodes = [41]
            self.graph.nodes[44].active_nodes = [41]
            self.graph.nodes[45].active_nodes = [44]
            self.graph.nodes[46].active_nodes = [44]
            self.graph.nodes[47].active_nodes = [44]

        if workload_name == 'efficientnet':
            self.graph.nodes[2].active_nodes = [1]
            self.graph.nodes[3].active_nodes = [1]

            self.graph.nodes[7].active_nodes = [6]
            self.graph.nodes[8].active_nodes = [6]

            self.graph.nodes[10].active_nodes = [9]
            self.graph.nodes[11].active_nodes = [9]
            self.graph.nodes[12].active_nodes = [9, 11]
            self.graph.nodes[13].active_nodes = [9, 11]
            self.graph.nodes[14].active_nodes = [9]

            self.graph.nodes[17].active_nodes = [16]
            self.graph.nodes[18].active_nodes = [16]

            self.graph.nodes[20].active_nodes = [19]
            self.graph.nodes[21].active_nodes = [19]
            self.graph.nodes[22].active_nodes = [19, 21]
            self.graph.nodes[23].active_nodes = [19, 21]
            self.graph.nodes[24].active_nodes = [19]

            self.graph.nodes[27].active_nodes = [26]
            self.graph.nodes[28].active_nodes = [26]

            self.graph.nodes[30].active_nodes = [29]
            self.graph.nodes[31].active_nodes = [29]
            self.graph.nodes[32].active_nodes = [29, 31]
            self.graph.nodes[33].active_nodes = [29, 31]
            self.graph.nodes[34].active_nodes = [29]

            self.graph.nodes[35].active_nodes = [34]
            self.graph.nodes[36].active_nodes = [34]
            self.graph.nodes[37].active_nodes = [34, 36]
            self.graph.nodes[38].active_nodes = [34, 36]
            self.graph.nodes[39].active_nodes = [34]
            ...
            self.graph.nodes[45].active_nodes = [44]
            self.graph.nodes[46].active_nodes = [44]
            self.graph.nodes[47].active_nodes = [44, 46]
            self.graph.nodes[48].active_nodes = [44, 46]
            self.graph.nodes[49].active_nodes = [44]

            self.graph.nodes[50].active_nodes = [49]
            self.graph.nodes[51].active_nodes = [49]
            self.graph.nodes[52].active_nodes = [49, 51]
            self.graph.nodes[53].active_nodes = [49, 51]
            self.graph.nodes[54].active_nodes = [49]

            self.graph.nodes[57].active_nodes = [56]
            self.graph.nodes[58].active_nodes = [56]

            self.graph.nodes[60].active_nodes = [59]
            self.graph.nodes[61].active_nodes = [59]
            self.graph.nodes[62].active_nodes = [59, 61]
            self.graph.nodes[63].active_nodes = [59, 61]
            self.graph.nodes[64].active_nodes = [59]

            self.graph.nodes[65].active_nodes = [64]
            self.graph.nodes[66].active_nodes = [64]
            self.graph.nodes[67].active_nodes = [64, 66]
            self.graph.nodes[68].active_nodes = [64, 66]
            self.graph.nodes[69].active_nodes = [64]

            self.graph.nodes[70].active_nodes = [69]
            self.graph.nodes[71].active_nodes = [69]
            self.graph.nodes[72].active_nodes = [69, 71]
            self.graph.nodes[73].active_nodes = [69, 71]
            self.graph.nodes[74].active_nodes = [69]

            self.graph.nodes[77].active_nodes = [76]
            self.graph.nodes[78].active_nodes = [76]
    ...
    def node_input_weight_size(self, node):
        ...
        if len(node.pred_nodes) > 0:
            ...
            for pred_node in node.pred_nodes:
                ...
                # MobileNet V2:
                if node.operator['problem']['type'] == 'DEP' and self.graph.nodes[pred_node].operator['problem']['type'] == 'C2D':
                    lcm_tile_budgets[6] = np.maximum(pred_node_tile_budgets[5], node_tile_budgets[6])
                elif node.operator['problem']['type'] == 'C2D' and self.graph.nodes[pred_node].operator['problem']['type'] == 'DEP':
                    lcm_tile_budgets[4] = np.maximum(pred_node_tile_budgets[6], node_tile_budgets[4])
                else:
        ...
        if len(node.active_nodes) > 0:
            for active_node_idx in node.active_nodes:
                ...
                K = active_node.operator['problem']['K']
                H = active_node.operator['problem']['H']
            ...
            if len(node.succ_nodes) > 0:
                for succ_node in node.succ_nodes:
                    if self.pred_nodes_visited(self.graph.nodes[succ_node], visit_nodes):
                        print(idx, succ_node, "6666666666666666666666666666666")
                        succ_node_weight_size0, succ_node_input_size0, _, _, _ = self.node_input_weight_size(self.graph.nodes[succ_node])
    ...
    def segment_perf(self, accelerator, architecture, save_dir, segment_start, segment_end):
        ...
        for level_id in range(segment_start, segment_end):
            ...
            if 'type' in operator['problem'].keys() and operator['problem']['type'] == 'T2D':
            ...
            # if layer_problem['problem']['P'] == 56:
            #     P_budgets = np.array([0, 0, 0, 1], dtype=np.int32)
            #     Q_budgets = np.array([0, 0, 0, 1], dtype=np.int32)
            #     C_budgets = np.array([8, 2, 1, 0], dtype=np.int32)
            #     K_budgets = np.array([8, 2, 1, 0], dtype=np.int32)
            #     H_budgets = np.array([8, 2, 1, 0], dtype=np.int32)
            #     intra_tile_budgets = [None, None, P_budgets, Q_budgets, C_budgets, K_budgets, H_budgets, pre_tile_budgets[-1]]
            # else:
            #     intra_tile_budgets = [None, None, pre_tile_budgets[layer_problem['problem']['P']]]
            if segment_start == segment_end - 1:
                pre_tile_budgets = None
            else:
                pre_tile_budgets = [None, None, self.layer2budgets[operator['problem']['P']][0],
                                    self.layer2budgets[operator['problem']['P']][1],
                                    self.layer2budgets[operator['problem']['P']][2],
                                    self.layer2budgets[operator['problem']['P']][3],
                                    self.layer2budgets[operator['problem']['P']][4],
                                    self.layer2budgets[operator['problem']['P']][5]]
                if level_id == segment_end - 1 or level_id == segment_start:
                    pre_tile_budgets[4] = None
            print("pre_tile_budgets: pre_tile_budgets: ", pre_tile_budgets)
            ...
            if level_id == segment_end - 1:
                memory_latency = -1 * layer_chkpt['best_latency']
                memory_energy = -1 * layer_chkpt['best_energy']
                level_latency += memory_latency
                level_energy += memory_energy
